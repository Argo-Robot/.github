...
- [**EKF State Estimation for Humanoids**](https://github.com/Argo-Robot/ekf_locomotion): EKF model to estimate humanoid state (pose + velocities) based on floating base dynamics equations.
